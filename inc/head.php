<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
 ...
 <head> 
  ...
  <meta name="description" content="<?php $this->options->hexo_description();?>" /> 
  <meta name="keywords" content="<?php $this->options->hexo_keywords();?>" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:title" content="<?php $this->options->hexo_title();?>" /> 
  <meta property="og:url" content="<?php $this->permalink() ?>" /> 
  <meta property="og:site_name" content="<?php $this->options->hexo_title();?>" /> 
  <meta property="og:description" content="<?php $this->options->hexo_description();?>" /> 
  <meta property="og:locale" content="zh-CN" /> 
  <meta name="twitter:card" content="summary" /> 
  <meta name="twitter:title" content="<?php $this->options->hexo_title();?>" /> 
  <meta name="twitter:description" content="<?php $this->options->hexo_description();?>" /> 
